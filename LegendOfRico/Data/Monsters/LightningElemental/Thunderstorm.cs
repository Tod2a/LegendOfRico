...
{
    public class Thunderstorm: LightningElemental
    {
        public override string MonsterName { get; set; } = "Orage";
        ...
        protected override MonsterHit[] BuildHitTable()
        {
            ...
            {
                new MonsterHit {Name ="Pluie d'éclair", MinDamage = 9, MaxDamage = 14},
                new MonsterHit { Name = "Fatal foudre", MinDamage = 15, MaxDamage = 25 }
            };
