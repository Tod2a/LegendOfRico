namespace LegendOfRico.Data
{
    public class JoyBean: Boss
    {
        ...
        public override int MonsterCurrentHP { get; set; } = 1300;
        public override int MonsterHP { get; set; } = 1300;
        ...
        public override int XpGranted { get; set; } = 1500;
        ...
        protected override MonsterHit[] BuildHitTable()
        {
            ...
            {
                new MonsterHit{Name = "Gomu rafale", MinDamage = 60, MaxDamage = 75}
            };
        }
    }
}
