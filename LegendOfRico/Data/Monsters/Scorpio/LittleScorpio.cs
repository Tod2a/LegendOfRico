namespace LegendOfRico.Data
{
    public class LittleScorpio: Scorpio
    {
        ...
        public override int MonsterHP { get; set; } = 40;
        public override int MonsterCurrentHP { get; set; } = 40;
        public override string fightImgUrl { get; set; } = "img/monster/Scorpio/littlescorpio.png";
        public override int XpGranted { get; set; } = 80;
        ...
        protected override MonsterHit[] BuildHitTable()
        {
            return new MonsterHit[]
                {
                    new MonsterHit{Name = "Morsure", MinDamage = 4, MaxDamage = 10 },
                    new MonsterHit{Name = "Piqure", MinDamage = 6, MaxDamage = 9}
                };
        }
    }
}
