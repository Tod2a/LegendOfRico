namespace LegendOfRico.Data
{
    public class Gangster: Bandit
    {
        ...
        public override int MonsterHP { get; set; } = 90;
        public override int MonsterCurrentHP { get; set; } = 90;
        ...
        public override int MinCoins { get; protected set; } = 15;
        public override int MaxCoins { get; protected set; } = 50;
